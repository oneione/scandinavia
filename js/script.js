(function($){
    ...
    var aboutTab = new riverHouse.TabController({
    ...
    var constructionTab = new riverHouse.TabController({
        tabLinkSelector: '.construction__link',
        tabLinkAttr: 'href',
        tabWindowSelector: '.construction__content',
        openTabNumber: 0,
        init: function($firstLink, $firstWindow, showTab) {
            if(!$firstLink.length) return;
            showTab($firstLink,$firstWindow);
